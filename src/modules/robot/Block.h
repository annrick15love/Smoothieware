...
class Block {
    public:
        ...
        using tickinfo_t= struct {
            double steps_per_tick; // 2.30 fixed point
            double counter; // 2.30 fixed point
            double acceleration_change; // 2.30 fixed point signed
            double deceleration_change; // 2.30 fixed point
            double plateau_rate; // 2.30 fixed point
